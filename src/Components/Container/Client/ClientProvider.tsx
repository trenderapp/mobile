...
import { initStorage, setStorage } from '../../../Services/storage';
...
function ClientProvider({ children }: SectionProps) {
    ...
    const connecToToken = async (token: string) => {
        ...
        if (user.error || !user.data) return await connectToNewUser();
    ...
    async function splash() {
        ...
        return await connecToToken(user_token);
    }
