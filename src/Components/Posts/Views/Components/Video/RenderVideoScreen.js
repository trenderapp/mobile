...
export default class RenderVideoScreen extends Component {
   ...
   */
  renderBack() {
    return this.renderControl(<IconButton style={{ margin: -5 }} icon="chevron-left" />,
      this.events.onBack,
    ...
    return (
      <View style={styles.volume.container}>
        ...
        <View
          ...
          <IconButton style={{ margin: -5 }} icon="volume-low" />
        </View>
      </View>
    );
  }
   ...
   */
  renderPlayPause() {
    return this.renderControl(this.state.paused === true ? <IconButton style={{ margin: -5 }} icon="play" /> : <IconButton style={{ margin: -5 }} icon="pause" />,
      this.methods.togglePlayPause,
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <IconButton icon="close-circle-outline" iconColor="#CC3300" />
