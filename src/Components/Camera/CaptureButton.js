...
import { START_RECORDING_DELAY, CAPTURE_BUTTON_SIZE, BORDER_WIDTH, SCREEN_HEIGHT, PAN_GESTURE_HANDLER_FAIL_X, PAN_GESTURE_HANDLER_ACTIVE_Y } from "./Constant";
...
const _CaptureButton = ({
  ...
  const takePhoto = useCallback(async () => {
    try {
      ...
      const photo = Platform.OS === "android" ? await camera.current.takeSnapshot({
        photoCodec: 'jpeg',
  ...
  const onHandlerStateChanged = useCallback(async ({ nativeEvent: event }) => {
